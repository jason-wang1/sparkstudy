package com.machinelearning.charpter06.classification.stumbleupon
...
object AllInOneClassification {
	...
	def main(args: Array[String]) {
		...
		val records = sc.textFile("C:\\Users\\BoWANG\\IdeaProjects\\sparkstudy\\src\\main\\scala\\com\\machinelearning\\charpter06\\classification\\dataset\\stumbleupon\\train_noheader.tsv").map(line => line.split("\t"))
